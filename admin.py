...
def start_admin(user,password, win1 = "default"):
    ...
    logout=Button(admin,text='Logout',bg='Red',fg='Black', activeforeground='black')#, bd='2', font=fineFont, command=lambda x=admin: start_login(admin)
    ...
    img = ImageTk.PhotoImage(Image.open(str(abs_path)+"\\library_1.jpg").resize((1050, 440), Image.ANTIALIAS))
    ...
    def add_book():
        ...
        lboxs = Listbox(labelFrame, bg="#cecece", relief="sunken",font=("courier",15),fg="black")
        ...
        ADD = Button(labelFrame,text="ADD NEW BOoOK",fg="black",bg="#7d7d7d",command=add_new)
